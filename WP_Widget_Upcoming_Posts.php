...
class WP_Widget_Upcoming_Posts extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_upcoming_entries', 'description' => __( 'The upcoming posts on your site','wp-upcoming-posts-widget') );
		parent::__construct('upcoming-posts', __('Upcoming Posts','wp-upcoming-posts-widget'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Upcoming Posts','wp-upcoming-posts-widget') : $instance['title'], $instance, $this->id_base);
